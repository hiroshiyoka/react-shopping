...
function App() {
  return (
    <div className="boxparent">
      <PhotoProduct/>
      <ProductInfo isDiscount="coming" name="Vans SK8-Hi" category="SKATE SNEAKER"/>
      <ReviewItems  />
    </div>
  );
}
...
function PhotoProduct() {
  return (
    <div className="photo-product">
      <img src="vansk8hi.png" alt='vans-skate-hi'/>
    </div>
  );
}
...
function ProductInfo(props) {
  ...
  return (
    ...
    <div className="description">
      ...
      <CheckDiscount isDiscount={isDiscount} discount={45} />
      <p className="info">
      ...
      <a onClick={(e) => addCart(name, e)} href="//#endregion">Add to Cart</a>
    </div>
    </div>
  );
}
